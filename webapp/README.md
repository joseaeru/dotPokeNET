...
4. **Levantar el backend**dotnet run --project WebAPI/WebAPI.csproj5. **Levantar el frontend**cd webapp
   npm install
   npm run dev
---
...
4. **Start the backend**dotnet run --project WebAPI/WebAPI.csproj5. **Start the frontend**cd webapp
npm install
   npm run dev
---
